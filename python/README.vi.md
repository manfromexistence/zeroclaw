...
Gói Python đồng hành cho [Agent](https://github.com/agent-labs/agent) — gọi công cụ dựa trên LangGraph cho thực thi agent LLM nhất quán.
...
| Tính năng | Rust Agent | agent-tools |
|---------|---------------|----------------|
...
Dùng **Rust Agent** cho triển khai biên (edge) trong sản phẩm. Dùng **agent-tools** khi cần đảm bảo tính nhất quán gọi công cụ hoặc tích hợp hệ sinh thái Python.
