# Agent ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Agent edge scenarios on ESP32.
...
3. Connect UI state with Agent edge/runtime messaging
...
- [Agent Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
