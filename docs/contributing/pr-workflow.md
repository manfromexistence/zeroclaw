# Agent PR Workflow (High-Volume Collaboration)

This document defines how Agent handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Agent/project-native labels.
...
- Confirm any required identity-like wording uses Agent/project-native terminology.
