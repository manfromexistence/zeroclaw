# Agent Contributor License Agreement (CLA)
...
property rights granted by contributors to Agent Labs. This agreement
protects both contributors and users of the Agent project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the Agent repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to Agent Labs
  for inclusion in the Agent project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"Agent Labs"** means the maintainers and organization responsible
  for the Agent project at https://github.com/agent-labs/agent.

---

## 2. Grant of Copyright License

You grant Agent Labs and recipients of software distributed by Agent
...
Agent that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Agent
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with Agent Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the Agent name,
...
Agent Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the Agent project are licensed under
both:
...
By opening a pull request or submitting a patch to the Agent repository,
...
https://github.com/agent-labs/agent/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the Agent dual-license model.*
