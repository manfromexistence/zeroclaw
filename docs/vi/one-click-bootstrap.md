...
Cách cài đặt và khởi tạo Agent nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài Agent), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image Agent cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.agent-docker`.
