...
Agent hỗ trợ các model GLM của Z.AI thông qua các endpoint tương thích OpenAI.
Hướng dẫn cấu hình thực tế theo provider hiện tại của Agent.

## Tổng quan

Agent hỗ trợ sẵn các alias và endpoint Z.AI sau đây:
...
### Kiểm tra bằng Agent CLI

```bash
# Test agent directly
echo "Hello" | agent agent
