...
| Hardware | RAM | Agent (base) | Agent (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, Agent uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### Agent's Core Promise: Swap Anything
