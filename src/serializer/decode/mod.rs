...
///     .with_strict(true)
///     .with_delimiter(serializer::Delimiter::Pipe);
...
///     Value,
/// };
/// use serializer::decode_no_coerce;
///
...
/// let result: Value = serializer::decode_default("value: true")?;
